<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard.Master" AutoEventWireup="true" CodeBehind="RejectComment.aspx.cs" Inherits="Project7.RejectComment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" class="container auto-style1 table table-striped table-hover table-condensed"  AutoGenerateRows="False">
        <Fields>
            ...
            <asp:Button ID="Button1" runat="server" Text="Reject" OnClick="Button1_Click" class="btn btn-block btn-lg mt-4" style="background-color:darkorange !important; color:white" />
